...
import 'package:chat_app/services/firebase_fcm_config.dart';
  ...
  Future pushNotification({required Map<String, dynamic> data}) async {
    try {
      return await dio.post(
        ApiPath.fcmServer, // 'https://fcm.googleapis.com/fcm/send',
        data: jsonEncode(data),
        options: Options(
          headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'Authorization': 'key=${FirebaseFCMConfig.fcmTokenServerKey}'
          },
        ),
      );
