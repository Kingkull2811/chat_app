...
//
// import 'package:awesome_notifications/android_foreground_service.dart'; // TO AVOID CONFLICT WITH MATERIAL DATE UTILS CLASS
...
//         channelDescription: "This channel was successfully updated.",
//       ),
//     );
//   }
//
...
//         preciseSchedules: [
//           DateTime.now().add(const Duration(seconds: 10)).toUtc(),
//           DateTime.now().add(const Duration(seconds: 25)).toUtc(),
//           DateTime.now().add(const Duration(seconds: 45)).toUtc(),
//         ],
//         repeats: true,
//       ),
//     );
...
//   static Timer? updateNotificationAfter1Second;
//
